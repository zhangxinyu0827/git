...
% %         minDetScore = [30 15 30 30 20 30 15 25 0 20 30];
...
% %     minDetScore = [30 15 25 30 30 20 30 15  0 20 30];
%     other_param.minDetScore = minDetScore(i);
elseif strcmp(other_param.seq,'KITTI_test')
 ...
 if strcmp(other_param.seq,'PETS2009')  
            other_param.seqs=det_input_path{i}(16:end);
           
        elseif strcmp(other_param.seq,'MOT_Challenge_train')
            other_param.seqs=det_input_path{i}(27:end-4);

        elseif strcmp(other_param.seq,'MOT_Challenge_test')
            other_param.seqs=det_input_path{i}(26:end-4);
