...
%0807zxy
% other_param.appSel = '';              %                                                    (1)'cnn': CNN feature  (2)'': No appearnace 
...
%0807zxy
% other_param.appW = 0;                  % w_{app}                                            When appearance is not used (i.e. other_param.appSel = ''), the appearance parameters are ignored.
% other_param.motW = 1;                  % w_{mot} = 1-w_{app}   
% other_param.tspW = 7; 
...
% parameters for detection height model
other_param.dtX = 20;
other_param.dtY = 20;
other_param.coeffHeightLarge = 1.8;
other_param.coeffHeightSmall = 0.4;
other_param.confscHeight = 0.5;
other_param.scForTrain = 0.5;
