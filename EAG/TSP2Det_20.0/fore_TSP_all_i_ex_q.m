function tree_table=...
    fore_TSP_all_i_ex_q(tree_table,tree_table_len_now,tree_table_i_len_now,fore_TSP_all,fore_TSP_all_i,ISall_all)
...
%向前
ISall_now=getIsall_q( ISall_all,last_tsp_now);
...
% 在此次迭代中不进行加减，下次迭代时更新
    ...
    for scan_i=tree_table_i_len_now0+1:tree_table_i_len_now_i
        ...
        find_next=getNext_q(ISall_now,first_tsp_now,last_tsp_now);
