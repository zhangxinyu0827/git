function fore_TSP=PrintTspMat(ISall_all)
...
%         ISall(:,15)=(ISall(:,9)).^2+(ISall(:,10)).^2;
        ...
        fore_tsp=ISall(keep,:);
        fore_TSP{fore_TSP_i}=fore_tsp;
        fore_TSP_i=fore_TSP_i+1;
...
save ([ sceneInfo.imgFolder sceneInfo.sequence '-fore_TSP.mat'], 'fore_TSP','-V7.3');
