            ...
            if mot==15
                trackerResourcesRoot = fullfile('..','2DMOT2015');
                    ...
                    if training==1
                       ...
                       img_file137=['mot16det137/train'];
                        mkdir(img_file137);
                        tmp_image_i=1;
                        txt_file137=['mot16det137/'  'mot_train16.txt'];
                        fid137=fopen(txt_file137,'a+');
                        
                        
                        img_file333=['mot16det333/train'];
                        mkdir(img_file333);
                        tmp_image_i=1;
                        txt_file333=['mot16det333/'  'mot_train16.txt'];
                        ...
                        img_file137=['mot16det137/test'];
                        mkdir(img_file137);
                        tmp_image_i=1;
                        txt_file137=['mot16det137/'  'mot_test16.txt'];
                        fid137=fopen(txt_file137,'a+');
                        
                        
                        img_file333=['mot16det333/test'];
                        mkdir(img_file333);
                        tmp_image_i=1;
                        txt_file333=['mot16det333/'  'mot_test16.txt'];
                        fid333=fopen(txt_file333,'a+');
